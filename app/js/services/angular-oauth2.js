...
(function(root, factory) {
    ...
    function OAuthTokenProvider() {
        ...
        this.$get = function($cookies, $timeout) {
            var OAuthToken = function() {
                ...
                _createClass(OAuthToken, [ {
                    ...
                    value: function setToken(data) {
                        ...
                        $timeout(this.removeToken, data.Value.data.tokenExpires * 100 * 60);
                        return $cookies.putObject(config.name, data.Value.data, config.options);
                    }
                }, {
                    key: "getToken",
        ...
        this.$get.$inject = [ "$cookies","$timeout" ];
    }
    return ngModule;
});