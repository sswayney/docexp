// THIS IS A MODIFIED VERSION OF THE MAIN NG CONFIG FILE
// Use this to replace the one in node_modules
// File was edited at version 1.3.1
'use strict';
  ...
  stream = through.obj(function (file, encoding, callback) {
    ...
    if (configuration.environment) {
      if (_.get(jsonObj, configuration.environment, false)) {
        jsonObj = _.merge({}, jsonObj[configuration.environment], jsonObj[configuration.allEnvironments] || {});
      } else {
